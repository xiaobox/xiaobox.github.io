...
slug: 2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha
description: "目录滚动部署蓝绿发布为什么还需要蓝绿金丝雀发布（canary）金丝雀和蓝绿的对比灰度发布A/B Test实现"
date: 2022-04-19T07:13:43.000Z
image: https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/cover.jpg
original_url: https://mp.weixin.qq.com/s/zg7xvPiyn_at2FBl8POEFw
categories:
  - 云原生
tags:
  - Spring
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/001-85683945.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/002-0db443da.gif)

切分20%的流量到新版本后，新版本出现异常，则快速将流量切回老版本。

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/003-f1176a45.gif)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/004-30be6db0.jpg)

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/005-6b2d2a4c.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/006-dc42df37.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/007-d4432b28.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/008-9f1a0ffa.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/009-2fab79ea.png)
...
-   如果发布正常版本，则先检测是否有`-canary`后缀的ingress、service、deployment，如果有则先删除它们，再替换正常版本的镜像。
    ...
    ![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2022-04-19-hui-du-fa-bu-lan-l-bu-shu-jin-si-que-dou-shi-sha/010-8de89c6e.png)
...
需要注意的是，这与使用普通 Kubernetes 进行[金丝雀部署]的方式完全相同，但是在 Kubernetes 方式下控制流量分配需要调整每个 Deployment 的副本数目。例如，将 10％ 的流量发送到金丝雀版本（v2），v1 和 v2 的副本可以分别设置为 9 和 1。
...
spring cloud gateway也可以实现灰度发布，另外还有一款 spring cloud 的增强组件，可以实现灰度、蓝绿等功能（Discovery: https://github.com/Nepxion/Discovery）
