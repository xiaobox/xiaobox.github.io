---
title: "分布式事务：从理论到实践（一）"
slug: 2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi
description: "分布式事务：从理论到实践（一）从集中式到分布式20世纪60年代大型主机被发明出来，凭借其安全性和稳定性的表现"
date: 2020-10-27T04:43:15.000Z
image: https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/cover.jpg
original_url: https://mp.weixin.qq.com/s/mt05U1gOUrvj5jkIsjZ6Rg
categories:
  - 后端
tags:
  - 算法
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/001-e5eb3808.jpg)
...
以下是一个有3个结点的系统拓扑：![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/002-394ce86a.jpg)

分布式系统在遇到任何网络分区故障的时候，仍然需要能够保证对外提供满足一致性和可用性的服务，除非是整个网络环境都发生了故障。

假设 M到S1的通信失败，或S1结点挂了，那么就有S1、M和S2这两个分区。

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/003-1134e488.jpg)
...
下图是我从Open Group标准文件中对DTP模型部分的截图：![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/004-a7fcf41d.jpg)

DTP模型抽象 AP（应用程序）, TM（事务管理器）和 RM（资源管理器）的概念来保证分布式事务的强一致性。其中 TM 与 RM 间采用 XA 的协议进行双向通信。

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/005-00f17d84.jpg)与传统的本地事务相比，XA 事务增加了准备阶段，数据库除了被动接受提交指令外，还可以反向通知调用方事务是否可以被提交。TM 可以收集所有分支事务的准备结果，并于最后进行原子提交，以保证事务的强一致性。
...
二阶段提交“事务提交”示意图：![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/006-eb34e938.jpg)二阶段提交“事务回滚”示意图：

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/007-7e27effe.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/008-ad0c24f8.jpg)
...
本地消息表这个方案最初是 ebay 架构师 Dan Pritchett 在 2008 年发表给 ACM 的文章。该方案中会有消息生产者与消费者两个角色，假设系统 A 是消息生产者，系统 B 是消息消费者，其大致流程如下：![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/009-7d11fb19.jpg)
...
大致流程如下![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/010-0a5bdcde.jpg)
...
Seata目前提供四种事务模型：![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/011-5999cda1.jpg)

我们日常比较常用的是 AT和TCC，一种是无侵入的，一种是侵入性比较强的，在下面的文章中，我们将逐个说明。

### Seata的架构：

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/012-6cc491c7.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/013-e85cb6c0.jpg)
...
所谓AT模式，即自动事务（Automatic transaction）![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/014-345270ac.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/015-9849cb1a.jpg)执行阶段：
...
后面的文章我们将结合具体例子来看下Seata中AT、TCC这两个模式是如何落地以及在开发过程中遇到的问题，敬请期待。

![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2020-10-27-fen-bu-shi-shi-wu-cong-li-lun-dao-shi-jian-yi/016-44a5086d.gif)
