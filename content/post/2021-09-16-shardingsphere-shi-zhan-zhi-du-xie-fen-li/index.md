---
title: "ShardingSphere 实战之读写分离"
slug: 2021-09-16-shardingsphere-shi-zhan-zhi-du-xie-fen-li
description: "简述采用 ShardingShpere 的 Sharding-Porxy（透明化的数据库代理端） 模式在本地"
date: 2021-09-16T00:06:00.000Z
image: https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2021-09-16-shardingsphere-shi-zhan-zhi-du-xie-fen-li/cover.jpg
original_url: https://mp.weixin.qq.com/s/3Rxfm9f4tgC7vNsyhl-3ew
categories:
  - 数据库
tags:
  - Java
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2021-09-16-shardingsphere-shi-zhan-zhi-du-xie-fen-li/001-6747986e.jpg)
...
![Image](https://pub-f29bf2b53160470c9a85250116509a24.r2.dev/post/2021-09-16-shardingsphere-shi-zhan-zhi-du-xie-fen-li/002-d2409aed.jpg)
...
2 启动报错：`The MySQL server is running with the --read-only option so it cannot execute this statement`我的从库是设置的只读库，但不知道为什么会报错，没有解决，再次启动就好了。
